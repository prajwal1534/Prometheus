  ...
  return (
    <div className="flex flex-row justify-between p-10">
      <div className="card bg-base-100 w-96 shadow-xl border-[2px] border-green-400 ">
        <figure
          className={cn(
            "group h-[250px]  w-full cursor-pointer overflow-hidden relative card   rounded-xl shadow-xl mx-auto flex flex-col justify-end p-4 border border-transparent dark:border-neutral-800",
            ...
            "before:bg-[url(https://scitechdaily.com/images/Photovoltaic-Panels-Solar-Farm.gif)] before:fixed before:inset-0 before:opacity-0 before:z-[-1]",
